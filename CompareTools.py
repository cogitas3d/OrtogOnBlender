...
def GeraPlanilha():
    ...
    with open(tmpdir+'/Report_CompareOnBlender.csv', mode='w') as centroid_file:
        ...
        Media = (CalculaDistanciaObjetos("Pronasale digi", "Pronasale real")+CalculaDistanciaObjetos("Exocanthus-Alar Base right digi", "Exocanthus-Alar Base right real")+CalculaDistanciaObjetos("Cheek right digi", "Cheek right real")+CalculaDistanciaObjetos("Alar Base right digi", "Alar Base right real")+CalculaDistanciaObjetos("Subnasale digi", "Subnasale real")+CalculaDistanciaObjetos("Alar Base left digi", "Alar Base left real")+CalculaDistanciaObjetos("Cheek left digi", "Cheek left real")+CalculaDistanciaObjetos("Exocanthus-Alar Base left digi", "Exocanthus-Alar Base left real")+CalculaDistanciaObjetos("Cheilion-Alar Base right digi", "Cheilion-Alar Base right real")+CalculaDistanciaObjetos("Cupid's Bow right digi", "Cupid's Bow right real")+CalculaDistanciaObjetos("Cupid's Bow left digi", "Cupid's Bow left real")+CalculaDistanciaObjetos("Cheilion-Alar Base left digi", "Cheilion-Alar Base left real")+CalculaDistanciaObjetos("Cheilion right digi", "Cheilion right real")+CalculaDistanciaObjetos("Cheilion left digi", "Cheilion left real")+CalculaDistanciaObjetos("Lower Lip digi", "Lower Lip digi")+CalculaDistanciaObjetos("B point soft digi", "B point soft real")+CalculaDistanciaObjetos("Pogonion soft digi", "Pogonion soft real"))/17
